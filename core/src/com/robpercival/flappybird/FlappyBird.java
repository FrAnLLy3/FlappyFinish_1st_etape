...
public class FlappyBird extends ApplicationAdapter {
	...
	public void create () {
		...
		oiseauxs  = new Texture[2];
		oiseauxs [0] = new Texture("bird.png");
		oiseauxs [1] = new Texture("bird2.png");


		topTube = new Texture("toptube.png");
		bottomTube = new Texture("bottomtube.png");
		maxTubeOffset = Gdx.graphics.getHeight() / 2 - gap / 2 - 100;
		generateurRandomme = new Random();
		distanceBetweenTubes = Gdx.graphics.getWidth() * 3 / 4;
		topTubeRectangles = new Rectangle[numeroDesTubes];
		bottomTubeRectangles = new Rectangle[numeroDesTubes];
	...
	public void startGame() {
		...
		birdY = Gdx.graphics.getHeight() / 2 - oiseauxs [0].getHeight() / 2;
